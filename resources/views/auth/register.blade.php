<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        ...
        <p class="text-sm text-gray-500 mt-2 font-medium">Bergabunglah untuk mulai menjelajahi event seru.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="block text-sm font-bold text-gray-700 mb-1.5">{{ __('Nama Lengkap') }}</label>
        ...
        <!-- Password -->
        <div>
            <label for="password" class="block text-sm font-bold text-gray-700 mb-1.5">{{ __('Password') }}</label>
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-sm font-bold text-gray-700 mb-1.5">{{ __('Konfirmasi Password') }}</label>
    ...
    <p class="mt-8 text-center text-sm text-gray-600 font-medium">
        Sudah punya akun?
        <a href="{{ route('login') }}" class="font-bold text-blue-600 hover:text-blue-500 hover:underline transition-colors">
            Masuk di sini
        </a>
    </p>
</x-guest-layout>